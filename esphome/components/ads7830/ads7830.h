...
private:
  ...
  uint8_t channel_values_[NCHAN];
  Ads7830Channel *channels_[MAX_SENSORS];
  int num_channels_{0};
...
public:
  Ads7830() {}
  uint8_t get_channel_value(uint8_t ch) const { return this->channel_values_[ch]; }
  ...
  void register_channel(Ads7830Channel *channel);
